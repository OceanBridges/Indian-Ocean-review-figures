...
#load your data; within seasons column mention the season to plot together
  data <- read.table("surface rates.txt", header = TRUE, na.strings = "NaN")
...
####rate plotting by ggplot 
 ggplot(data = world) +
   ...
   scale_color_manual( values=c("blue3" , "deeppink", "seagreen", "blue3" , "deeppink", "seagreen"))+ scale_radius(range = c(1,6),limits=c(0.03,25),breaks=c(0.5,2.5,5,10,15,20,25))
